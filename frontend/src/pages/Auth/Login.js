      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-100">
          <div className="text-center mb-4">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">🚀 Try Demo Accounts</h3>
          ...
          <div className="grid grid-cols-2 gap-3 text-xs">
            ...
            <div className="bg-white/60 rounded-lg p-3 border border-green-200">
              <div className="font-semibold text-green-800 mb-1">👨‍🏫 Teacher</div>
              <div className="text-gray-700">teacher@edupredict.com</div>
              <div className="text-gray-600">teacher123</div>
            </div>
            <div className="bg-white/60 rounded-lg p-3 border border-purple-200">
              <div className="font-semibold text-purple-800 mb-1">🎓 Student</div>
            ...
            <div className="bg-white/60 rounded-lg p-3 border border-orange-200">
              <div className="font-semibold text-orange-800 mb-1">📊 Analyst</div>

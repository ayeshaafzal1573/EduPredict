...
const TeacherNotifications = () => {
  ...
  const getNotificationColor = (type) => {
    switch (type) {
      case 'student_alert': return 'bg-red-100 text-red-800';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl shadow-xl p-8 text-white">
        <h1 className="text-4xl font-bold mb-2">🔔 Teacher Notifications</h1>
        <p className="text-green-100 text-lg">
          Stay informed about your students and classes
        </p>
        {unreadCount > 0 && (
          <div className="mt-4">
